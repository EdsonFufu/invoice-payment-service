...
@SpringBootTest
class PaymentServiceImplTestAuthDecline {
    ...
    @Test
    void declineAuth() {
        StateMachine<PaymentState, PaymentEvent> sm = paymentService.declineAuth(18L);
        Payment declinePayment = paymentRepository.getReferenceById(18L);
        System.out.println(sm.getState().getId());
        System.out.println(declinePayment);
    }
}